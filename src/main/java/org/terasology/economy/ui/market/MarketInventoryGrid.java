...
/**
 */
public class MarketInventoryGrid extends CoreWidget {
    ...
    private List<MarketInventoryCell> cells = Lists.newArrayList();
    ...
    public void update(float delta) {
        ...
        if (numSlots < cells.size()) {
            ...
            for (int i = cells.size(); i < numSlots && i < getMaxCellCount(); ++i) {
                MarketInventoryCell cell = new MarketInventoryCell();
