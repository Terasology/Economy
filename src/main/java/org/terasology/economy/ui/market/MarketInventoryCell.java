...
/**
 * Adds interaction between a market inventory slot and the player
 */
public class MarketInventoryCell extends ItemCell {
    private static final Logger logger = LoggerFactory.getLogger(MarketInventoryCell.class);
    @LayoutConfig
